...
final class SHLocationTableViewCell: UITableViewCell {
    static let identifier = "SHLocationTableViewCell"
    ...
    public func configure(with viewModel: SHLocationTableViewCellViewModel) {

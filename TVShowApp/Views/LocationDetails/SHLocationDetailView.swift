...
protocol SHLocationDetailViewDelegate: AnyObject {
...
final class SHLocationDetailView: UIView {
    public weak var delegate: SHLocationDetailViewDelegate?
    
    private var viewModel: SHLocationDetailViewViewModel? {
        didSet {
    ...
    public func configure(with viewModel: SHLocationDetailViewViewModel) {
        self.viewModel = viewModel
    }
}

extension SHLocationDetailView {
...
extension SHLocationDetailView: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        switch sectionType {
            ...
            case .characters:
                ...
                delegate?.shLocationDetailView(self, didSelect: character)
        }
    }
}
